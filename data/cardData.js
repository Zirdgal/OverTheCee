...
const equipmentData = { name: "Equipment", id: "equipment" , used: false, path: document.getElementById("equipment-card"), cost: "0", option1: "Resource", option1Level: "2", option2: "March", option2Level: "2" };
