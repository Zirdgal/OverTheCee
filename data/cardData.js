...
const karlisUlmanisData = { name: "Kārlis Ulmanis", id: "ulmanis", used: false, path: document.getElementById("karlis-ulmanis-card"), cost: "2", option1: "Resource", option1Level: "5", option2: "none", option2Level: "0" };
...
const alliedShipsData = { name: "English and French War Fleet", id: "fleet", used: false, path: document.getElementById("allied-ships-card"), cost: "1", option1: "Resource", option1Level: "2", option2: "alliedShips", option2Level: "1" };
