...
const alliedShipsData = { name: "English and French War Fleet", used: false, path: document.getElementById("allied-ships-card"), cost: "1", option1: "Resource", option1Level: "2", option2: "alliedShips", option2Level: "1" };
